        ...
        computed: {
            classes() {
                return this.active
                            ...
                            : 'block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-grey-600 hover:text-grey-800 hover:bg-grey-500 hover:border-gray-300 focus:outline-none focus:text-grey-800 focus:bg-grey-500 focus:border-gray-300 transition duration-150 ease-in-out'
            }
        }
    }
</script>
